...
model_selection = st.selectbox("Select Model", ["", "Random Forest ", "XGBoost model"], key="model_selection")
...
# Dataframe creation
my_dict = {
    "Average Monthly Hours": avg_monthly_hours,
    "Satisfaction Level": satisfaction_level,
    "Last Evaluation": last_evaluation,
    "Number of Projects": num_project,
    "Time in Company (years)": time_in_company,
    "Employee Salary Category": salary,
    "Department": selected
}
